...
class BackupManagerTest {
    ...
    fun exportThenImport_restoresStructuredData() = runBlocking {
        ...
        database.saleDao().insert(
            SaleEntity(
                ...
                treeId = "tree-1",
                linkedHarvestId = null,
                soldAt = 1_730_000_000_000,
                quantityValue = 1.0,
                quantityUnit = "plant",
                unitPrice = 45.0,
                totalPrice = 45.0,
                currencyCode = "USD",
                saleChannel = SaleChannel.NURSERY,
        ...
        assertThat(validation.saleCount).isEqualTo(1)
        ...
        assertThat(database.saleDao().getAllSales()).hasSize(1)
    ...
    @Test
    fun exportThenImport_restoresActivityPhotoAttachments() {
        runBlocking {
            database.treeDao().insert(
                TreeEntity(
                    id = "tree-1",
